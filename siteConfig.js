module.exports = {
  siteUrl: "https://3d787.com", // Site domain. Do not include a trailing slash!

  postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

  siteTitleMeta: "3d787", // This allows an alternative site title for meta data for pages.
  siteDescriptionMeta:
    "3d787", // This allows an alternative site description for meta data for pages.

  shareImageWidth: 1000, // Change to the width of your default share image
  shareImageHeight: 523, // Change to the height of your default share image

  shortTitle: "3d787", // Used for App manifest e.g. Mobile Home Screen
  siteIcon: "favicon.png", // Logo in /static dir used for SEO, RSS, and App manifest
  backgroundColor: "#e9e9e9", // Used for Offline Manifest
  themeColor: "#15171A", // Used for Offline Manifest
  apiUrl: "https://reshet.jetdomains.co.il/3d787",
  subscribeWidget: {
    visible: false,
    title: "3d787",
  ...
  footer: {
    ...
    navigation: [
      ...
      {
        label: "Sitemap",
        url: "https://3d787.com/sitemap.xml",
      },
